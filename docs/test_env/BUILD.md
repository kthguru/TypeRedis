...
```yaml
# version: 4.1.0  # Previous version
version: 4.2.0   # New version
```
...
Create a new release on GitHub. Use the tag you just created (e.g., `v4.2.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
