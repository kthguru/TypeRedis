...
```yaml
# version: 4.2.0  # Previous version
...
Create a new release on GitHub. Use the tag you just created (e.g., `v4.3.0`). Copy the relevant section from `CHANGELOG.md` into the release notes.
