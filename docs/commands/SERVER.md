...
| `commandCount`           | [COMMAND COUNT](https://redis.io/docs/latest/commands/command-count/)                     | [COMMAND COUNT](https://valkey.io/commands/command-count/)                     | yes |
| `commandDocs`            | [COMMAND DOCS](https://redis.io/docs/latest/commands/command-docs/)                       | [COMMAND DOCS](https://valkey.io/commands/command-docs/)                       | yes |
| `commandGetKeys`         | [COMMAND GETKEYS](https://redis.io/docs/latest/commands/command-getkeys/)                 | [COMMAND GETKEYS](https://valkey.io/commands/command-getkeys/)                 | yes |
| `commandGetKeysAndFlags` | [COMMAND GETKEYSANDFLAGS](https://redis.io/docs/latest/commands/command-getkeysandflags/) | [COMMAND GETKEYSANDFLAGS](https://valkey.io/commands/command-getkeysandflags/) | yes |
| `commandHelp`            | [COMMAND HELP](https://redis.io/docs/latest/commands/command-help/)                       | [COMMAND HELP](https://valkey.io/commands/command-help/)                       | yes |
| `commandInfo`            | [COMMAND INFO](https://redis.io/docs/latest/commands/command-info/)                       | [COMMAND INFO](https://valkey.io/commands/command-info/)                       | yes |
| `commandList`            | [COMMAND LIST](https://redis.io/docs/latest/commands/command-list/)                       | [COMMAND LIST](https://valkey.io/commands/command-list/)                       | yes |
...
| `configHelp`             | [CONFIG HELP](https://redis.io/docs/latest/commands/config-help/)                         | [CONFIG HELP](https://valkey.io/commands/config-help/)                         | yes |
...
| `dbSize`                 | [DBSIZE](https://redis.io/docs/latest/commands/dbsize/)                                   | [DBSIZE](https://valkey.io/commands/dbsize/)                                   | yes |
...
| `flushAll`               | [FLUSHALL](https://redis.io/docs/latest/commands/flushall/)                               | [FLUSHALL](https://valkey.io/commands/flushall/)                               | yes |
| `flushDb`                | [FLUSHDB](https://redis.io/docs/latest/commands/flushdb/)                                 | [FLUSHDB](https://valkey.io/commands/flushdb/)                                 | yes |
| `info`                   | [INFO](https://redis.io/docs/latest/commands/info/)                                       | [INFO](https://valkey.io/commands/info/)                                       | yes |
| `infoServerMetadata`     |                                                                                           |                                                                                | |
...
| `latencyDoctor`          | [LATENCY DOCTOR](https://redis.io/docs/latest/commands/latency-doctor/)                   | [LATENCY DOCTOR](https://valkey.io/commands/latency-doctor/)                   | yes |
| `latencyGraph`           | [LATENCY GRAPH](https://redis.io/docs/latest/commands/latency-graph/)                     | [LATENCY GRAPH](https://valkey.io/commands/latency-graph/)                     | yes |
| `latencyHelp`            | [LATENCY HELP](https://redis.io/docs/latest/commands/latency-help/)                       | [LATENCY HELP](https://valkey.io/commands/latency-help/)                       | yes |
| `latencyHistogram`       | [LATENCY HISTOGRAM](https://redis.io/docs/latest/commands/latency-histogram/)             | [LATENCY HISTOGRAM](https://valkey.io/commands/latency-histogram/)             | yes |
| `latencyHistory`         | [LATENCY HISTORY](https://redis.io/docs/latest/commands/latency-history/)                 | [LATENCY HISTORY](https://valkey.io/commands/latency-history/)                 | yes |
| `latencyLatest`          | [LATENCY LATEST](https://redis.io/docs/latest/commands/latency-latest/)                   | [LATENCY LATEST](https://valkey.io/commands/latency-latest/)                   | yes |
| `latencyReset`           | [LATENCY RESET](https://redis.io/docs/latest/commands/latency-reset/)                     | [LATENCY RESET](https://valkey.io/commands/latency-reset/)                     | yes |
| `lolWut`                 | [LOLWUT](https://redis.io/docs/latest/commands/lolwut/)                                   | [LOLWUT](https://valkey.io/commands/lolwut/)                                   | yes |
| `memory`                 | [MEMORY](https://redis.io/docs/latest/commands/memory/)                                   | [MEMORY](https://valkey.io/commands/memory/)                                   | |
| `memoryDoctor`           | [MEMORY DOCTOR](https://redis.io/docs/latest/commands/memory-doctor/)                     | [MEMORY DOCTOR](https://valkey.io/commands/memory-doctor/)                     | yes |
| `memoryHelp`             | [MEMORY HELP](https://redis.io/docs/latest/commands/memory-help/)                         | [MEMORY HELP](https://valkey.io/commands/memory-help/)                         | yes |
| `memoryMallocStats`      | [MEMORY MALLOC-STATS](https://redis.io/docs/latest/commands/memory-malloc-stats/)         | [MEMORY MALLOC-STATS](https://valkey.io/commands/memory-malloc-stats/)         | yes |
| `memoryPurge`            | [MEMORY PURGE](https://redis.io/docs/latest/commands/memory-purge/)                       | [MEMORY PURGE](https://valkey.io/commands/memory-purge/)                       | yes |
| `memoryStats`            | [MEMORY STATS](https://redis.io/docs/latest/commands/memory-stats/)                       | [MEMORY STATS](https://valkey.io/commands/memory-stats/)                       | yes |
| `memoryUsage`            | [MEMORY USAGE](https://redis.io/docs/latest/commands/memory-usage/)                       | [MEMORY USAGE](https://valkey.io/commands/memory-usage/)                       | yes |
| `module`                 | [MODULE](https://redis.io/docs/latest/commands/module/)                                   | [MODULE](https://valkey.io/commands/module/)                                   | |
| `moduleHelp`             | [MODULE HELP](https://redis.io/docs/latest/commands/module-help/)                         | [MODULE HELP](https://valkey.io/commands/module-help/)                         | yes |
...
| `monitor`                | [MONITOR](https://redis.io/docs/latest/commands/monitor/)                                 | [MONITOR](https://valkey.io/commands/monitor/)                                 | yes |
...
| `role`                   | [ROLE](https://redis.io/docs/latest/commands/role/)                                       | [ROLE](https://valkey.io/commands/role/)                                       | yes |
...
| `slowLogHelp`            | [SLOWLOG HELP](https://redis.io/docs/latest/commands/slowlog-help/)                       | [SLOWLOG HELP](https://valkey.io/commands/slowlog-help/)                       | yes |
...
| `time`                   | [TIME](https://redis.io/docs/latest/commands/time/)                                       | [TIME](https://valkey.io/commands/time/)                                       | yes |